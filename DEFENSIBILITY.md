...
### Short Ship (~$184K, ~814 deductions)
...
### Label Fine (~$197K, ~344 deductions)
...
**Rebuttal to "every manufacturer gets label fines":** At ~$197K/year,
...
### Late Delivery (~$88K, ~457 deductions)
...
is expected. ~$92K in charges should be cross-referenced against
...
### Damaged Goods (~$63K, ~98 deductions)
...
SOP issue. At ~$14K it is the smallest category, but the fix
...
### Vague / Unclassified (~$294K, ~189 deductions)
...
"should this exist?" but "does it match a planned promotion?" — see
the ghost promo analysis on Tab 3.

---

## The addressable total

Of ~$1.01M in trailing-365 operational waste:

- **~$933K is addressable** (Probable Waste + Unknown buckets) —
  deductions that can be reduced through operational improvement,
  process fixes, or active dispute.
- **~$79K is contractual** (slotting) — a negotiated term, not an
  operational failure.
